...
host = os.getenv("host", "https://demo.homebox.software")
...
df["HB.asset_id"] = df.apply(lambda row: f'<a href="{host}{row["HB.url"]}" target="_blank">{row["HB.asset_id"]}</a>', axis=1)
...
f7 = open("html-templates/header6.html", 'r')
